  ...
  export default {
    ...
    data () {
      return {
        ...
        showf: true,
        backgroundObj: {
          background: 'url(' + require('./../../../assets/GeneralIcon/thumbs.png') + ') 0px 2px/4.5rem no-repeat'
        },
        backgroundObj2: {
          background: 'url(' + require('./../../../assets/GeneralIcon/Chat_yes.png') + ') 0px 2px/4.5rem no-repeat'
        },
        showAlert: false,
        alertText: null,
        items: [
    ...
    methods: {
      ...
      goodFun () {
        this.backgroundObj.background = 'url(' + require('./../../../assets/GeneralIcon/thumbs_yes.png') + ') 0px 2px/4.5rem no-repeat'
        // 点赞更新vueX
...
<style type="text/css">
 ...
 #thumbsIcon{
  ...
  width: 60px;
  height: 57px;
  /*background: url("./../../../assets/GeneralIcon/Chat_yes.png") -8px 2px no-repeat;*/
