<template>
  <div id="articles">
    ...
    <section class="articles-main">
      ...
      <section class="articles-main-title">
        <div class="articles-title-left">
          <span >议题列表</span>
        </div>
        <div v-if="!directoriesShow" class="articles-title-right">
          <span  @click="showCheckmark">目录</span>
        </div>
      </section>
      <section class="menu_container">
        <ul class="menu_container_ul">
          ...
          <div class="lookMore" v-if="bookList.length > 2" :class="{active: !isFixationHight}"><p @click="lookMore()">{{lookMoreText}}</p></div>
        </ul>
