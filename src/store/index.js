...
//  唱响古今
    ...
    poemList: [
      {
        ...
        currentTime: 0,
        duration: 0,
        backgroundUrl: require('../images/poem/poem01.jpg'),
        ...
        currentTime: 0,
        duration: 0,
        backgroundUrl: require('../images/poem/poem02.jpg'),
  ...
  // 轮播图
  carouselImgList: [{
    imgUrl: require('../images/home/banner_0001.jpg')
  }, {
    imgUrl: require('../images/home/banner_0002.jpg')
  }, {
    imgUrl: require('../images/home/banner_0003.jpg')
  }],
  /*
   //目录
   */
  ...
  bookList: [{
    ...
    articleList: [{
      ...
      titel: '盘古开天辟地',
      imag: '',
      article: '&emsp;&emsp;传说在很久很久以前，天和地还没有分开，整个宇宙混沌一团，像个大鸡蛋。就在大鸡蛋的内部，有个叫盘古的大神，昏睡了一万八千年。' +
      ...
      titel: '淤能棋吕岛',
      imag: '',
      article: '&emsp;&emsp;伊奘诺尊和伊奘冉尊诞生后就一直生活在高高的天上，但是天上太清静了，他们常常感到无聊。' +
      ...
      titel: '冰雪巨人--伊密尔',
      imag: '',
      article: '&emsp;&emsp;最早的时候，没有天，也没有地，没有海，也没有空气。整个世界只存在冷和热两个地方。冷是冰雪，热是火焰，中间隔着一条又宽又深的大裂缝。如果冷热相遇，就会发出“嚓嚓”的巨响，使那些冰山受热熔化。升起的水汽凝结成为寒霜，越积越多，填满了广阔无边的天空。久而久之，一个巨大无比的人从冰雪与火焰的撞击中诞生了，它就是伊密尔。几乎和伊密尔同时出生的，还有一头叫作乌特赫姆拉的大母牛，它喷出许多牛奶供伊密尔食用。母牛不吃草，却吃冰块，冰山慢慢被它吃掉不少，渐渐露出一个巨人，他就是被冰层掩盖的神的祖先蒲利。这时伊密尔正在睡觉，蒲利的孙子奥丁就把冰雪巨人伊密尔杀死了。“众神之王”奥丁就将巨人伊密尔的身体制造成世界：头做天，肉做地，骨做山，牙齿做岩石，血汗变成海洋，头发变成村木百草，脑浆变成浮云；他又命令名叫东、南、西、北的四个小矮人立在大地的四角，各人用肩膀扛住天；又取来火团布满在天空上，成为耀眼的星星。其中最大的火团就是太阳和月亮。这样，天地万物就造出来了。'
    }, {
      id: 4,
      titel: '梵天创世',
      imag: '',
      article: '&emsp;&emsp;很久以前，世界上还没有太阳，没有月亮，也没有星星，只是一片汪洋大海。' +
      ...
      titel: '阿胡拉•马兹达创世',
      imag: '',
      article: '&emsp;&emsp;在最初的时候，整个世界由光明和黑暗组成。而光明由善神阿胡拉•马兹达掌管，黑暗由恶神安哥拉掌管。' +
  ...
  //  乐创编
    createObj: {
      ...
      recommendBgImg: require('../images/home/thoughtBg01.jpg'),
      discuss: '创世神话里的秘密',
      chooseImg: '',
      createList: []
      //  {
